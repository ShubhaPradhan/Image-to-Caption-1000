...
output_dir = 'D:/Image-to-Caption-1000/uploaded_images_with_attention'
...
def generate_caption_with_gradio(image):
    ...
    image_path = os.path.join('D:/Image-to-Caption-1000/uploaded_images', image_filename)
    
    # Save the uploaded image
    image.save(image_path)

    # Load the model
    checkpoint = torch.load('D:/Image-to-Caption-1000/BEST_checkpoint_flickr8k_5_cap_per_img_5_min_word_freq.pth.tar', map_location='cpu')

    # Load the word ma
    with open('D:/Image-to-Caption-1000/Flickr8k_preprocessed/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json', 'r') as j:
